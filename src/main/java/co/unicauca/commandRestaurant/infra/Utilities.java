...
public class Utilities {
    ...
    /**
    * Metodo estatico que encripta un string
    * @param s String que se encripta
    * return parametro encriptado
    */
    public static String encriptarComida(String s) throws UnsupportedEncodingException{
        return Base64.getEncoder().encodeToString(s.getBytes("utf-8"));
    }
    
    /**
    * Metodo que descifra un string encriptado
    * param s String a decifrar
    * return String desencriptado
    */
    public static String desencriptarComida(String s) throws UnsupportedEncodingException{
