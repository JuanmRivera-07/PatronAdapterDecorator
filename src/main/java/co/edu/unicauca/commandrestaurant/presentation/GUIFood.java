...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        Food food = new CapitalFood(id, name, foodTpye);
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        if (food == null) {
            ...
            txtName.setText(desincriptar(food.getName()));
            cboType.setSelectedItem(food.getType().toString());
        }

    }//GEN-LAST:event_txtIdFocusLost
    private String desincriptar(String foodName){
        try {
            String nombreEncriptado = Utilities.desencriptarComida(foodName);
